...
const universityItems: Item[] = [
    { id: 1, text: 'Exceed Expectations', image: '/heart.png', description: "Students come to your esteemed University and Nursing program to learn, prepare & pass the NCLEX®, and prepare for their first job. These days, that's the bare minimum. By partnering with Nursify Education, your current & future students won't just remember their education with you, but celebrate it." },
    { id: 2, text: 'Save Your Students', image: '/coworker.png', description: "Every student invests their hard-earned, and often borrowed, money in you in exchange for the best education possible. Nurses want to be confident, knowledgeable, and set up for success, not just for their first job, but their entire career. Nursify Education has identified crucial skills nurses must know to avoid workplace injury and burnout." },
...
const employerItems: Item[] = [
    ...
    { id: 3, text: 'Reduce Staff Turnover', image: '/2.jpg', description: "Caring for others doesn't stop with your patients; you know how important it is to value your employees. THe nursing shortage is expected to worsen through 2030, cherishing them must go beyond words of appreciation & small celebrations of milestones. To keep your best, you must invest. By parterning with Nursfiy Education, the payoff is massive and the investment is minimal. What they gain will speak volumes for how much you treasure them for being them." },
